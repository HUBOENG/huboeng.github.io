const clients = [
  ...
  },
  {
    ...
    description: 'Boutique jungle resort in Sauraha, Chitwan.',
    sector: 'Hospitality',
  ...
  {
    name: 'Jagrit Kusadhevi Co-operative Ltd',
    initials: 'JK',
    description: 'Financial co-operative serving the Kusadhevi community, Kavre.',
    sector: 'Co-operative',
  },
  {
    name: 'Sahara Co-operative Ltd',
    initials: 'SC',
    description: 'Savings and credit co-operative based in Kusadhevi, Kavre.',
    sector: 'Co-operative',
  },
  {
    name: 'Sarathi Multipurpose Co-operatives Ltd',
    initials: 'SM',
    description: 'Multipurpose co-operative providing financial and community services.',
    sector: 'Co-operative',
    website: 'https://www.sarathi.org.np',
  },
  {
    name: 'हिमाल बहुउद्देश्य सहकारी संस्था',
    initials: 'हि',
    description: 'Multipurpose co-operative based in Kusadhevi, Kavrepalanchowk.',
    sector: 'Co-operative',
  },
]
    ...
    <section id="clients" className="border-t border-line bg-base-900 py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            <p className="mono-label">Trusted by</p>
            ...
            >
              <div className="flex h-20 w-20 items-center justify-center rounded-xl bg-white p-2 ring-1 ring-line">
                {c.logo ? (
                  ...
                  <span className="font-display text-xl font-bold text-acc-500">
                    {c.initials}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="max-w-[200px] text-xs leading-relaxed text-fg-dim">
                  {c.description}
                </p>
              </div>
