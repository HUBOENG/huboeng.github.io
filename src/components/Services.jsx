...
const icons = {
  ...
  flask: (
    <path d="M9 3h6M10 3v6l-5 9a2 2 0 002 3h10a2 2 0 002-3l-5-9V3M7.5 15h9" />
  ),
};
...
const services = [
  {
    ...
    summary:
      "We design, construct, and consult across civil engineering projects.",
  ...
  },
  {
    ...
    summary:
      "Full-stack web platforms, custom business tools, and IT solutions.",
  ...
  },
  {
    ...
    summary:
      "A wide range of services and facilities, including electronics supply.",
        ...
        <div className="border-t border-line bg-base-900 px-6 py-4">
          <p className="text-sm text-fg-dim">
            ...
            <a
              ...
              className="text-acc-500 hover:underline"
            >
              {service.contact}
            </a>
          </p>
        ...
        <div className="mt-16 border-t border-line">
          {services.map((s) => (
            <button
              key={s.key}
              onClick={() => setActive(s)}
              className="group grid w-full grid-cols-1 items-center gap-4 border-b border-line py-8 text-left transition-colors hover:bg-base-850/60 md:grid-cols-[1.4fr_1.6fr_auto] md:gap-8 md:px-4"
            >
